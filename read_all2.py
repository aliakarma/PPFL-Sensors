...
print("\n--- SYNTHETIC ---")
print(df[df['d_name'] == 'synthetic'][['fl_acc', 'att']].mean())
print("\n--- ENSEMBLE ---")
print(df[df['ens'] == 'ensemble'].groupby('grp')[['fl_acc', 'att']].mean())
print("\n--- BASELINE HAR ---")
print(df[(df['d_name'] == 'har') & (df['ens'] == 'fedavg') & (df['grp'] == 3)][['fl_acc', 'att']].mean())
